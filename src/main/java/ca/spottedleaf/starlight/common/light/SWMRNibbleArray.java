...
public final class SWMRNibbleArray {
    ...
    // operation type: updating
    public int getUpdating(final long x, final long y, final long z) {
        return this.getUpdating((int) ((x & 15) | ((z & 15) << 4) | ((y & 15) << 8)));
    }
    ...
    // operation type: visible
    public int getVisible(final long x, final long y, final long z) {
        return this.getVisible((int) ((x & 15) | ((z & 15) << 4) | ((y & 15) << 8)));
    }
